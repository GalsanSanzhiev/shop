...
function App() {
  const [products] = useState([
    ...
    },
    {
      ...
      characteristics:
        "Версия ОС iOS 26, Датчики: акселерометр, альтиметр, гироскоп, датчик освещенности, датчик сердечного ритма, компас, температурн",
      colors: ["white", "black"],
      colorImages: {
    ...
    },
    {
      ...
      characteristics:
        "Разъём зарядки: USB Type-C, Комплектация: документация, кабель USB Type-C - USB Type-C, чехол",
      colors: ["white", "black"],
      colorImages: {
    ...
    },
    {
      ...
      characteristics:
        "Память: 1000 ГБ, Оперативная память: 16 ГБ, Модель процессора: AMD Ryzen Zen 2",
      colors: ["white"],
      colorImages: {
    ...
    },
    {
      ...
      price: 175300,
      description:
        "MacBook Pro M5 512 ГБ, Оперативная память: 16 ГБ, Диагональ экрана (дюйм): 14.2, Количество ядер: 10, Модель процессора: Apple M5 10-core",
      colors: ["black"],
      colorImages: {
    ...
    },
    {
      ...
      price: 9890,
      description:
        "Разъём зарядки: USB Type-C, Версия Bluetooth: 5.3, Материал корпуса: пластик",
      colors: ["white"],
      colorImages: {
  ...
  // Открытие и закрытие модалки с формой ======================================================
